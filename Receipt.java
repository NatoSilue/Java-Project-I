...
public class Receipt extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.println("<center><img src = 'images/top.PNG' style=\" width: 90px;\"\"height= 80px;\"></center><hr width=\"60px\">");
			out.println("<div>");
			...
			out.println("Phone  : "+ request.getParameter("customerPhone") + "</br>");
			out.println("</p></center>");
			out.println("</div>");
			out.println("</div>");
			out.println("<div id=\"table\">");
			out.println("<center><table cellspacing =\"15\">");
			out.println("<center><tr class=\"service\">");
